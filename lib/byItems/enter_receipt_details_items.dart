...
import 'enter_items.dart'; // Your next screen
import '../models.dart'; // Import the Person and Receipt class
import 'package:flutter_native_contact_picker/flutter_native_contact_picker.dart';
import 'package:flutter_native_contact_picker/model/contact.dart';

class EnterReceiptDetailsItemsScreen extends StatefulWidget {
  @override
  _EnterReceiptDetailsItemsScreenState createState() => _EnterReceiptDetailsItemsScreenState();
}

class _EnterReceiptDetailsItemsScreenState extends State<EnterReceiptDetailsItemsScreen> {
