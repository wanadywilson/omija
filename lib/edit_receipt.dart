...
void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    color: Colors.white, // Change back arrow color here
        ...
        title: Text('Edit Receipt',style: TextStyle(color: Colors.white)),
        actions: [
          IconButton(
            icon: Icon(Icons.add),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            icon: Icon(Icons.delete, color: Color.fromARGB(255,94,19,16)),
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: totalsMatch ? Color.fromARGB(255,94,19,16) : Colors.grey,
